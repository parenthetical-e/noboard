...
# details
Tensorboard saves its data to a json file. You could parse that, for much the same effect. But the format is no small amount opaque, and not documented. This library is a simpler and stable. 
